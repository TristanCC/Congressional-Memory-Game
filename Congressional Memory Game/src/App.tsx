...
function App() {
  ...
  return (
    <>
      <div className={`${gamePlaying? 'visible':'invisible'} fixed right-8 top-1/2 w-12 bg-[#121212] flex items-center rounded-xl flex-col`}>
        <h1>{score}</h1>
        <h1>{highScore}</h1>
      </div>
      <div className={` ${spinning === true? 'animate-spin-slow' : 'animate-none'} background -z-20 fixed w-full h-full grayscale opacity-15 `} />
